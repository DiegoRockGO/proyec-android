...
import com.uy.csi.sige.adapters.MyEventAdapter;
import com.uy.csi.sige.adapters.MyPadronListAdapter;
...
public class FragmentEvents extends Fragment {
    ...
    private PadronDaoImpl padronService;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        ...
        ImageButton btnNewEvent = (ImageButton) view.findViewById(R.id.btn_new_event);

        padronService=new PadronDaoImpl(view.getContext());
        ...
        btnNewEvent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( !isEmpty(padronList) ){
                    int index = padronList.size() - 1;
                    Padron ev = new Padron();

                    loadFormEvent( view.getContext(), ConstanteNumeric.ADD, ConstanteNumeric.TYPE_DETECCION,  new Event() );
                    return;
                }
    ...
    public void loadTable(Context context,TextView view) {
        try {
            ...
            padronList=padronService.list( );

            listView.setAdapter(new MyPadronListAdapter(context, R.layout.item_event, padronList,listView, FragmentEvents.this));

            if (padronList == null || padronList.isEmpty()) {
    ...
    public void loadFormEvent(Context context,Integer accion,Integer typeForm,Event event){
        cleanData(context);

        new LoadFormEvent(context,accion,typeForm,event).execute();
    }
        ...
        final CustomDialogMessage dialog = new CustomDialogMessage() {
            ...
            public void confirm() {
                if(typeMessage== ConstanteNumeric.DLG_CONFIRM){
                    ...
                    padronService.delete(idevent,null);
    ...
    class LoadFormEvent extends AsyncTask<String, String, String>{
        ...
        public LoadFormEvent(Context context,Integer accion,Integer typeForm,Event event){
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                Intent i = new Intent(context, FormEventActivity.class);
                i.putExtra(ConstanteText.KEY_TYPE_PROCESS, accion);

                i.putExtra(ConstanteText.KEY_NAME_EVENT,event);
